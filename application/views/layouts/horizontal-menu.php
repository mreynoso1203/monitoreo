        ...
        <div class="d-flex">
            ...
            <form class="app-search d-none d-lg-block">
                <div class="position-relative">
                    ...
                    <button class="btn btn-danger" type="button"><i class="bx bx-search-alt align-middle"></i></button>
                </div>
            </form>
        </div>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-uielement" role="button">
                            ...
                            <span data-key="t-components">Páginas</span>
                        ...
                        <div class="dropdown-menu mega-dropdown-menu px-2 dropdown-mega-menu-xl" aria-labelledby="topnav-uielement">
                            <div class="ps-2 p-lg-0">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div>
                                            <div class="menu-title">Cambios en la Web</div>
                                            <div class="row g-0">
                                                <div class="col-lg-12">
                                                    <div>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-uielement" role="button">
                            <i data-feather="briefcase"></i>
                            <span data-key="t-components">Productos</span>
                            <div class="arrow-down"></div>
                        </a>
                        <div class="dropdown-menu mega-dropdown-menu px-2 dropdown-mega-menu-xl" aria-labelledby="topnav-uielement">
                            <div class="ps-2 p-lg-0">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div>
                                            <div class="menu-title">Gestión de catálogo</div>
                                            <div class="row g-0">
                                                <div class="col-lg-12">
                                                    <div>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="<?php echo base_url();?>web_solicitud" id="topnav-dashboard" role="button">
                            <i class="bx  bx bx-mail-send"></i><span data-key="t-dashboards">Solicitudes</span>
                        </a>
                    </li>
